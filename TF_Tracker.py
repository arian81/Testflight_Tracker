...
testflight_id = input("Enter the testflight id or link to the testflight beta program    >   ")
CHAT_ID = int(input("Enter the user id recivied from t.me/userinfobot     >     ")) 
BOT_TOKEN = input("Enter the bot token recived from t.me/botfather        >     ")
